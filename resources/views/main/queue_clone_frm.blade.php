<x-layouts.auth-layout subtitle="{{ $subtitle }}">
   <div class="main-card overflow-auto">
    ...
    <form action="{{ route('queue.edit.submit') }}" method="post">
        ...
        <p class="text-sm text-slate-400 mb-4"><i class="fa-solid fa-circle-info me-2 text-yellow-500"></i>A duplicação da fila atual não vai duplicar os tickets da fila.</p>
